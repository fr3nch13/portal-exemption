...
// content
$th = array(
	'Exemption.id' => array('content' => __('Exemption ID'), 'options' => array('sort' => 'Exemption.id')),
...
foreach ($exemption_files as $i => $exemption_file)
{
	...
	$td[$i] = array(
		$this->Html->link($exemption_file['Exemption']['id'], array('controller' => 'exemptions', 'action' => 'view', $exemption_file['Exemption']['id'])),
...
echo $this->element('Utilities.page_index', array(
	'page_title' => __('All %s', __('Exemption %s', __('Artifacts'))),
