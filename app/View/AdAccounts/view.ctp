...
$page_options = array(
	$this->Html->link(__('Edit'), array('action' => 'edit', $adAccount['AdAccount']['id'])),
);
...
$stats['ExemptionsAll'] = array(
	...
	'ajax_count_url' => array('controller' => 'exemptions', 'action' => 'ad_account', $adAccount['AdAccount']['id'], 'list' => 'all'),
	'tab' => array('tabs', (count($tabs) + 1)), // the tab to display
);
$tabs['ExemptionsAll'] = array(
	'key' => 'ExemptionsAll',
	'title' => __('%s %s', __('All'), __('Exemptions')),
	'url' => array('controller' => 'exemptions', 'action' => 'ad_account', $adAccount['AdAccount']['id'], 'list' => 'all'),
);
...
$stats['ExemptionsActive'] = array(
	...
	'ajax_count_url' => array('controller' => 'exemptions', 'action' => 'ad_account', $adAccount['AdAccount']['id'], 'list' => 'active'),
	'tab' => array('tabs', (count($tabs) + 1)), // the tab to display
);
$tabs['ExemptionsActive'] = array(
	'key' => 'ExemptionsActive',
	'title' => __('%s %s', __('Active'), __('Exemptions')),
	'url' => array('controller' => 'exemptions', 'action' => 'ad_account', $adAccount['AdAccount']['id'], 'list' => 'active'),
);
...
$stats['ExemptionsExpired'] = array(
	...
	'ajax_count_url' => array('controller' => 'exemptions', 'action' => 'ad_account', $adAccount['AdAccount']['id'], 'list' => 'expired'),
	'tab' => array('tabs', (count($tabs) + 1)), // the tab to display
);
$tabs['ExemptionsExpired'] = array(
	'key' => 'ExemptionsExpired',
	'title' => __('%s %s', __('Expired'), __('Exemptions')),
	'url' => array('controller' => 'exemptions', 'action' => 'ad_account', $adAccount['AdAccount']['id'], 'list' => 'expired'),
);
...
$stats['ExemptionsReviewed'] = array(
	...
	'ajax_count_url' => array('controller' => 'exemptions', 'action' => 'ad_account', $adAccount['AdAccount']['id'], 'list' => 'reviewed'),
	'tab' => array('tabs', (count($tabs) + 1)), // the tab to display
);
$tabs['ExemptionsReviewed'] = array(
	'key' => 'ExemptionsReviewed',
	'title' => __('%s %s', __('Reviewed'), __('Exemptions')),
	'url' => array('controller' => 'exemptions', 'action' => 'ad_account', $adAccount['AdAccount']['id'], 'list' => 'reviewed'),
);
...
$stats['ExemptionsNotReviewed'] = array(
	...
	'ajax_count_url' => array('controller' => 'exemptions', 'action' => 'ad_account', $adAccount['AdAccount']['id'], 'list' => 'notreviewed'),
	'tab' => array('tabs', (count($tabs) + 1)), // the tab to display
);
$tabs['ExemptionsNotReviewed'] = array(
	'key' => 'ExemptionsNotReviewed',
	'title' => __('%s %s', __('Not Reviewed'), __('Exemptions')),
	'url' => array('controller' => 'exemptions', 'action' => 'ad_account', $adAccount['AdAccount']['id'], 'list' => 'notreviewed'),
);
